...
export MODEL_NAME="Qwen2.5-VL-7B" # 设置模型名称
export MODEL_PATH="/sxs/zhoufei/vLLM/models/Qwen2.5-VL-7B"   # 设置模型路径
export VLLM_HOST_IP=$(hostname -I | awk '{print $1}')    # 获取本机 IP 地址并在每个节点上设置
export PORT=8001   # 设置端口
export LOG_FILE="../logs/vlm_qwen2.5-vl-7b.log"  # 设置日志文件路径
